...
import com.vaadin.demo.dashboard.component.TopTenMoviesGrid;
...
public final class DashboardView extends Panel implements View,
    ...
    private Component buildContent() {
        ...
        dashboardPanels.addComponent(buildTop10TitlesByRevenueGrid());
    ...
    private Component buildTop10TitlesByRevenueGrid() {
        Component contentWrapper = createContentWrapper(new TopTenMoviesGrid());
        contentWrapper.addStyleName("top10-revenue-grid");
